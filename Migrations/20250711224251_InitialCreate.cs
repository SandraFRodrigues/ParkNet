        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentCardToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDriverLicenseValidated = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscriptions_ParkingSlots_ParkingSlotId",
                        column: x => x.ParkingSlotId,
                        principalTable: "ParkingSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "VehicleTypes",
                columns: new[] { "Id", "Code", "Designation" },
                values: new object[,]
                {
                    { 1, "C", "Car" },
                    { 2, "M", "Moto" }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_ParkingSlotId",
                table: "Subscriptions",
                column: "ParkingSlotId");
