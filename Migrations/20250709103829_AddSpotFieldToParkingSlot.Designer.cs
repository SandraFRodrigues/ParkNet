...
namespace ParkNet.Migrations
{
    ...
    [Migration("20250709103829_AddSpotFieldToParkingSlot")]
    partial class AddSpotFieldToParkingSlot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkNet.Entities.Enums.VehicleType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ParkNet.Entities.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ParkNet.Entities.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ParkNet.Entities.Infrastructure.ParkingSlot", b =>
                {
                    ...
                    b.HasOne("ParkNet.Entities.Enums.VehicleType", "VehicleType")
                        .WithMany("ParkingSlots")
            ...
            modelBuilder.Entity("ParkNet.Entities.Operations.ParkingTransaction", b =>
                {
                    ...
                    b.HasOne("ParkNet.Entities.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
